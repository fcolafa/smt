...
$this->breadcrumbs=array(
	Yii::t('database',Yii::t('database','Embarkations'))=>array('admin'),
...
$('.search-form form').submit(function(){
	$('#embarkation-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1><?php echo Yii::t('actions','Manage')?> <?php echo Yii::t('database','Embarkations')?></h1>
